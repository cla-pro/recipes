(function() {
    ...
    recipesControllers.component('appSearch', {
        templateUrl: 'components/search/search.html',
        controllerAs: 'vm',
        controller: ['$scope', '$stateParams', 'Restangular', '$timeout', SearchController]
    });

    function SearchController($scope, $stateParams, Restangular, $timeout) {
        var vm = this;
